...
//                }
                DoubleTensor[] directions = Directions.K.getDirections();
                double[] direction_weights = Directions.K.getDirectionWeights();
                ...
                BlockJacobiSmoother gss = new BlockJacobiSmoother(ag,new String[]{"0"});
                switch (solMethod)
                {
                        case 0:
